...
const LivrosPage = () => {
  ...
  const buscarLivros = async () => {
    ...
    try {
      ...
      if (termoBusca.trim() === "") {
        ...
        livros = await LivrosService.buscarTodosLivros(); // Supondo que exista esse método na API
      }else {
        if (filtro === "titulo") {
  ...
  const exibirDetalhesLivro = (titulo: string) => {
  ...
  <div className="max-w-4xl mx-auto p-8 bg-gray-50 rounded-lg shadow-lg text-black">
    ...
    <div className="mb-6">
      ...
      <select
        ...
        className="w-full p-3 mt-2 bg-white border-2 border-black rounded-md shadow-sm focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all"
      >
              ...
              <tr key={livro.isbn} className="hover:bg-indigo-50 transition-all">
                ...
                <td className="p-4">
                  <button
                    ...
                    className="px-4 py-2 bg-blue-500 text-black rounded-md hover:bg-blue-600 focus:ring-2 focus:ring-blue-500 transition-all"
                  >
                    Editar
                  </button>
                </td>
